...
from datasets.textDistribution import Context_sentences
...
class CoOp(TrainerX):
    ...
    def build_model(self):
        ...
        class_attributes = json.load(open(cfg.DATASET.class_attributes_path, 'r'))
        class_contexts = json.load(open(cfg.DATASET.class_contexts_path, 'r'))

        context_sentences = Context_sentences(cfg, class_descriptor, class_attributes, class_contexts, clip_model)
